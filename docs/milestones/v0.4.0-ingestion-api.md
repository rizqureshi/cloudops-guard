...
**is documentation and contract design only.** No API, storage,
authentication, uploader, or deployment infrastructure exists yet. This
document defines what v0.4.0 will be before any of it is built, in the same
spirit as `docs/milestones/v0.3.0-interactive-web-demo.md`'s Phase 3A.
...
**Storage interfaces (defined, not provisioned):**
